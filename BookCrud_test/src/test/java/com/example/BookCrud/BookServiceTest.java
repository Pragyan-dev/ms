...
class BookServiceTest {
    ...
    void delete() {
       ...
       // bookService.delete("1234");
        bookRepository.deleteById("123");
        assertThat(bookRepository.existsById("123")).isFalse();  //isTrue
        //doThrow(new RuntimeException("Error")).when(bookRepository).deleteById("123");
        //Assertions.assertThrows(RuntimeException.class, () -> bookService.delete("123"));
    }
